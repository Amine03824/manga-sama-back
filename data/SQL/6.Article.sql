...
VALUES
  ('9782368529904', (SELECT "1" FROM "article" WHERE "title" = 'Fullmetal Alchemist Perfect Tome 1')),
  ('9782871294146', (SELECT "2" FROM "article" WHERE "title" = 'Naruto Tome 1')),
  ('9782871294177', (SELECT "3" FROM "article" WHERE "title" = 'Naruto Tome 2')),
  ('9782871294276', (SELECT "4" FROM "article" WHERE "title" = 'Naruto Tome 3')),
  ('9782871294412', (SELECT "5" FROM "article" WHERE "title" = 'Naruto Tome 4')),
  ('9782871294917', (SELECT "6" FROM "article" WHERE "title" = 'Naruto Tome 5')),
  ('9782871292661', (SELECT "7" FROM "article" WHERE "title" = 'Hunter X Hunter Tome 1')),
  ('9782871292678', (SELECT "8" FROM "article" WHERE "title" = 'Hunter X Hunter Tome 2')),
  ('9782871292685', (SELECT "9" FROM "article" WHERE "title" = 'Hunter X Hunter Tome 3')),
  ('9782871292692', (SELECT "10" FROM "article" WHERE "title" = 'Hunter X Hunter Tome 4')),
  ('9782871292708', (SELECT "11" FROM "article" WHERE "title" = 'Hunter X Hunter Tome 5')),
  ('9782505000327', (SELECT "12" FROM "article" WHERE "title" = 'Death Note Tome 1')),
  ('9782915513585', (SELECT "13" FROM "article" WHERE "title" = 'Ubel Blatt Tome 0')),
  ('9782723455862', (SELECT "14" FROM "article" WHERE "title" = 'Reborn !')),
  ('9782505009993', (SELECT "15" FROM "article" WHERE "title" = 'Monster Intégrale')),
  ('9782811679811', (SELECT "16" FROM "article" WHERE "title" = 'L''attaque des titans')),
  ('9782344020685', (SELECT "17" FROM "article" WHERE "title" = 'Berserk')),
  ('9782380710243', (SELECT "18" FROM "article" WHERE "title" = 'Spy X Family')); 